...
// 
//--------------------
class BT_DECO_CONDITION_SEND_ZERGLING : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_SEND_ZERGLING(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeSendZergling(void* data);
