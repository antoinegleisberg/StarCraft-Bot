...
// 
//--------------------
class BT_DECO_CONDITION_STARTED_PHASE2 : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_STARTED_PHASE2(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool StartedPhase2(void *data);
