...
// 
//--------------------
class BT_DECO_CONDITION_MORPH_OVERLORDS : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_MORPH_OVERLORDS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeMorphOverlords(void* data);
