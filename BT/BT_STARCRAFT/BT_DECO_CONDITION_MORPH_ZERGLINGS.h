...
// 
//--------------------
class BT_DECO_CONDITION_MORPH_ZERGLINGS : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_MORPH_ZERGLINGS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeMorphZerglings(void* data);
