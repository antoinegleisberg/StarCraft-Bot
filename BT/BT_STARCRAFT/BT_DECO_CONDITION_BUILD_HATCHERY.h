...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_HATCHERY : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_HATCHERY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeBuildHatchery(void* data);
