...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_REFINERY : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_REFINERY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeBuildRefinery(void* data);
