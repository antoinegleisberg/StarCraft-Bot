...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_LAIR : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_LAIR(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeBuildLair(void* data);
