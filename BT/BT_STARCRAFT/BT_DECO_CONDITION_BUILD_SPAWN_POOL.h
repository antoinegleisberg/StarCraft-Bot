...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_SPAWN_POOL : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_SPAWN_POOL(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool DoWeBuildSpawningPool(void* data);
