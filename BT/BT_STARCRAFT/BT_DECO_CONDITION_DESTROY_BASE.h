...
//// 
////--------------------
//class BT_DECO_CONDITION_DESTROY_BASE : public BT_DECO_CONDITION {
//public:
//    BT_DECO_CONDITION_DESTROY_BASE(std::string name, BT_NODE* parent);
//    std::string GetDescription() override;
//
//    static bool DoWeDestroyBase(void* data);
//
//};
////----------