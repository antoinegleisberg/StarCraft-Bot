...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_VESPENE : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_VESPENE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughWorkersFarmingVespene(void* data);
